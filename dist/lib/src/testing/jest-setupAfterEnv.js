...
const setupPermanentMocks = () => {
    ...
    jest.useFakeTimers({
        ...
        now: new Date(constants_1.TEST_DEFAULT_DATE), // To customize in a test, use `jest.setSystemTime`
    });
    Math.random = () => constants_1.TEST_DEFAULT_MATH_RANDOM; // To customize in a given test, use `jest.spyOn(Math, "random").mockReturnValue(xx)`
};
...
//# sourceMappingURL=jest-setupAfterEnv.js.map