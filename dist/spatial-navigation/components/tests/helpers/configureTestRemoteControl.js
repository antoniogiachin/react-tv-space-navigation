...
__1.SpatialNavigation.configureRemoteControl({
    remoteControlSubscriber: (callback) => {
        const mapping = {
            [testRemoteControlManager_1.SupportedKeys.Right]: __1.Directions.RIGHT,
            [testRemoteControlManager_1.SupportedKeys.Left]: __1.Directions.LEFT,
            [testRemoteControlManager_1.SupportedKeys.Up]: __1.Directions.UP,
            [testRemoteControlManager_1.SupportedKeys.Down]: __1.Directions.DOWN,
            [testRemoteControlManager_1.SupportedKeys.Enter]: __1.Directions.ENTER,
