 ...
 * ```
 **/
const getRangeWithoutFloatHandling = ({ data, currentlyFocusedItemIndex, numberOfRenderedItems = 8, numberOfItemsVisibleOnScreen, scrollBehavior, }) => {
 ...
 */
const getRawStartAndEndIndexes = ({ currentlyFocusedItemIndex, numberOfItemsVisibleOnScreen, numberOfItemsNotVisible, scrollBehavior, }) => {
    ...
    switch (scrollBehavior) {
        case 'stick-to-start':
            return {
                ...
                rawEndIndex: currentlyFocusedItemIndex +
                    numberOfItemsVisibleOnScreen -
                    1 +
        ...
        case 'stick-to-end':
            return {
                rawStartIndex: currentlyFocusedItemIndex -
                    numberOfItemsVisibleOnScreen +
                    1 -
                    halfNumberOfItemsNotVisible,
 ...
 */
const getRange = ({ data, currentlyFocusedItemIndex, numberOfRenderedItems = 8, numberOfItemsVisibleOnScreen, scrollBehavior, }) => {
