...
describe('getRange for custom virtualized list', () => {
  ...
  `('should return proper range for array size $arraySize at index $focusIndex (case description: "$description")', ({ arraySize, focusIndex, numberOfRenderedItems, numberOfItemsVisibleOnScreen, result }) => {
        const input = new Array(arraySize).fill(1);
        const expectedResult = (0, getRange_1.getRange)({
            data: input,
    ...
    it('should log an error if the numberOfRenderedItems is negative', () => {
        ...
        const result = (0, getRange_1.getRange)({
            data: input,
