...
})(this, (__WEBPACK_EXTERNAL_MODULE__9155__, __WEBPACK_EXTERNAL_MODULE__1389__) => {
...
const jsx_runtime_1 = __webpack_require__(1085);
const react_1 = __webpack_require__(9155);
const SpatialNavigationVirtualizedListWithVirtualNodes_1 = __webpack_require__(3550);
const ParentScrollContext_1 = __webpack_require__(134);
const TypedMemo_1 = __webpack_require__(2382);
const DeviceContext_1 = __webpack_require__(169);
const react_native_1 = __webpack_require__(1389);
const SpatialNavigatorContext_1 = __webpack_require__(7886);
const react_2 = __importDefault(__webpack_require__(9155));
const TypedForwardRef_1 = __webpack_require__(4862);
...
var baseRange = __webpack_require__(6902),
    isIterateeCall = __webpack_require__(4535),
    toFinite = __webpack_require__(3301);
...
const getSizeInPxFromOneItemToAnother_1 = __webpack_require__(7184);
...
const lodash_uniqueid_1 = __importDefault(__webpack_require__(285));
const react_1 = __webpack_require__(9155);
const useUniqueId = ({
  prefix
...
const lrud_1 = __webpack_require__(795);
const isError_1 = __webpack_require__(1294);
class SpatialNavigator {
  constructor({
    ...
    this.handleQueuedFocus = () => {
      ...
      if (this.virtualNodeFocusQueue && ((_b = (_a = this.lrud.getNode(this.virtualNodeFocusQueue)) === null || _a === void 0 ? void 0 : _a.children) === null || _b === void 0 ? void 0 : _b.length) !== 0) {
        try {
...
(function (Directions) {
    ...
    Directions["LONG_ENTER"] = "long_enter";
...
const jsx_runtime_1 = __webpack_require__(1085);
const react_1 = __importStar(__webpack_require__(9155));
const DefaultFocusContext_1 = __webpack_require__(5900);
const ParentIdContext_1 = __webpack_require__(7994);
const ParentScrollContext_1 = __webpack_require__(134);
const SpatialNavigatorContext_1 = __webpack_require__(7886);
const useUniqueId_1 = __webpack_require__(668);
const IsRootActiveContext_1 = __webpack_require__(4743);
...
exports.SpatialNavigationNode = (0, react_1.forwardRef)(({
  ...
  (0, react_1.useEffect)(() => {
    spatialNavigator.registerNode(id, {
      ...
      onLongSelect: () => {
        var _a;
        return (_a = currentOnLongSelect.current) === null || _a === void 0 ? void 0 : _a.call(currentOnLongSelect);
      },
      orientation,
  ...
  return (0, jsx_runtime_1.jsx)(ParentIdContext_1.ParentIdContext.Provider, {
    value: id,
    children: typeof children === 'function' ? bindRefToChild(children(proxyObject)) : children
  });
});
...
const computeTranslation_1 = __webpack_require__(235);
const getLastItemIndex_1 = __webpack_require__(1114);
/**
...
const jsx_runtime_1 = __webpack_require__(1085);
const react_1 = __importDefault(__webpack_require__(9155));
const react_native_1 = __webpack_require__(1389);
const CustomScrollView_1 = __webpack_require__(1777);
exports.AnyScrollView = react_1.default.forwardRef((_a, ref) => {
  var {
      useNativeScroll
    } = _a,
    props = __rest(_a, ["useNativeScroll"]);
  if (useNativeScroll) {
    return (0, jsx_runtime_1.jsx)(react_native_1.ScrollView, Object.assign({
      ref: ref,
  ...
  return (0, jsx_runtime_1.jsx)(CustomScrollView_1.CustomScrollView, Object.assign({
    ref: ref
  }, props));
});
...
const react_native_1 = __webpack_require__(1389);
const react_1 = __webpack_require__(9155);
const CustomScrollView_hooks_1 = __webpack_require__(4665);
exports.CustomScrollView = (0, react_1.forwardRef)(({
  style,
  ...
  const updateRef = currentRef => {
    ...
    if (typeof ref === 'function') ref === null || ref === void 0 ? void 0 : ref(newRef);else if (ref) ref.current = newRef;
  };
...
const SpatialNavigatorContext_1 = __webpack_require__(7886);
const ParentIdContext_1 = __webpack_require__(7994);
const updateVirtualNodeRegistration_1 = __webpack_require__(4254);
const TypedMemo_1 = __webpack_require__(2382);
const useCachedValues_1 = __webpack_require__(4469);
const convertToGrid_1 = __webpack_require__(5945);
const VirtualizedListWithSize_1 = __webpack_require__(4499);
...
const jsx_runtime_1 = __webpack_require__(1085);
const Node_1 = __webpack_require__(1121);
const react_native_1 = __webpack_require__(1389);
const react_1 = __webpack_require__(9155);
const DeviceContext_1 = __webpack_require__(169);
const useSpatialNavigatorFocusableAccessibilityProps_1 = __webpack_require__(5009);
exports.SpatialNavigationFocusableView = (0, react_1.forwardRef)((_a, ref) => {
  ...
  return (0, jsx_runtime_1.jsx)(Node_1.SpatialNavigationNode, Object.assign({
    ...
    ref: nodeRef,
    children: nodeState => (0, jsx_runtime_1.jsx)(InnerFocusableView, {
      viewProps: viewProps,
      webProps: webProps,
      style: style,
      nodeState: nodeState,
...
const InnerFocusableView = (0, react_1.forwardRef)(({
  ...
  return (0, jsx_runtime_1.jsx)(react_native_1.View, Object.assign({
    ...
    children: typeof children === 'function' ? children(nodeState) : children
  }));
});
...
const react_native_1 = __webpack_require__(1389);
const TypedMemo_1 = __webpack_require__(2382);
const VirtualizedList_1 = __webpack_require__(6636);
const react_1 = __webpack_require__(9155);
/**
...
exports.VirtualizedListWithSize = (0, TypedMemo_1.typedMemo)(props => {
  ...
  return (0, jsx_runtime_1.jsx)(react_native_1.View, {
    ...
    children: (0, jsx_runtime_1.jsx)(VirtualizedList_1.VirtualizedList, Object.assign({}, props, {
      listSizeInPx: listSizeInPx
    }))
  });
});
...
const SpatialNavigator_1 = __importDefault(__webpack_require__(793));
const react_1 = __webpack_require__(9155);
...
const ParentIdContext_1 = __webpack_require__(7994);
const SpatialNavigatorContext_1 = __webpack_require__(7886);
const useCreateSpatialNavigator_1 = __webpack_require__(4867);
const useRemoteControl_1 = __webpack_require__(8451);
const LockSpatialNavigationContext_1 = __webpack_require__(6466);
const IsRootActiveContext_1 = __webpack_require__(4743);
const ROOT_ID = 'root';
const SpatialNavigationRoot = ({
  ...
  return (0, jsx_runtime_1.jsx)(SpatialNavigatorContext_1.SpatialNavigatorContext.Provider, {
    ...
    children: (0, jsx_runtime_1.jsx)(LockSpatialNavigationContext_1.LockSpatialNavigationContext.Provider, {
      value: lockActions,
      children: (0, jsx_runtime_1.jsx)(IsRootActiveContext_1.IsRootActiveContext.Provider, {
        value: isRootActive,
...
const chunk_1 = __importDefault(__webpack_require__(8126));
...
const react_1 = __importStar(__webpack_require__(9155));
const react_native_1 = __webpack_require__(1389);
const range_1 = __importDefault(__webpack_require__(3758));
const SpatialNavigationVirtualizedList_1 = __webpack_require__(6806);
const SpatialNavigatorContext_1 = __webpack_require__(7886);
const ParentIdContext_1 = __webpack_require__(7994);
const TypedMemo_1 = __webpack_require__(2382);
const convertToGrid_1 = __webpack_require__(5945);
...
const GridRow = ({
  ...
  return (0, jsx_runtime_1.jsx)(HorizontalContainer, {
    ...
    children: row.items.map((item, columnIndex) => {
      const itemIndex = rowIndex * numberOfColumns + columnIndex;
      return /* This view is important to reset flex direction to vertical */(0, jsx_runtime_1.jsx)(react_native_1.View, {
...
exports.SpatialNavigationVirtualizedGrid = (0, TypedMemo_1.typedMemo)((0, TypedForwardRef_1.typedForwardRef)((_a, ref) => {
  var {
    ...
    props = __rest(_a, ["renderItem", "data", "numberOfColumns", "itemHeight", "header", "headerSize", "additionalRenderedRows", "onEndReachedThresholdRowsNumber", "nbMaxOfItems", "rowContainerStyle"]);
...
const react_1 = __webpack_require__(9155);
const react_native_1 = __webpack_require__(1389);
const getRange_1 = __webpack_require__(6942);
const useVirtualizedListAnimation_1 = __webpack_require__(2812);
const TypedMemo_1 = __webpack_require__(2382);
const getSizeInPxFromOneItemToAnother_1 = __webpack_require__(7184);
const createScrollOffsetArray_1 = __webpack_require__(1620);
const getNumberOfItemsVisibleOnScreen_1 = __webpack_require__(7116);
const getAdditionalNumberOfItemsRendered_1 = __webpack_require__(7233);
...
const ItemContainerWithAnimatedStyle = (0, TypedMemo_1.typedMemo)(({
  ...
  const computeOffset = (0, react_1.useCallback)((item, index) => typeof itemSize === 'number' ? index * itemSize : data.slice(0, index).reduce((acc, item) => acc + itemSize(item), 0), [data, itemSize]);
  const style = (0, react_1.useMemo)(() => react_native_1.StyleSheet.flatten([styles.item, vertical ? {
    transform: [{
      translateY: computeOffset(item, index)
    }]
  } : {
    transform: [{
      translateX: computeOffset(item, index)
    }]
...
exports.VirtualizedList = (0, TypedMemo_1.typedMemo)(({
  ...
  return (0, jsx_runtime_1.jsx)(react_native_1.Animated.View, {
    ...
    children: (0, jsx_runtime_1.jsx)(react_native_1.View, {
      children: dataSliceToRender.map((item, virtualIndex) => {
        ...
        return (0, jsx_runtime_1.jsx)(ItemContainerWithAnimatedStyle, {
          ...
          vertical: vertical,
          data: data
        }, keyExtractor ? keyExtractor(index) : recycledKeyExtractor(index));
      })
    })
  });
});
...
const jsx_runtime_1 = __webpack_require__(1085);
const Node_1 = __webpack_require__(1121);
const SpatialNavigationVirtualizedListWithScroll_1 = __webpack_require__(105);
const TypedMemo_1 = __webpack_require__(2382);
const TypedForwardRef_1 = __webpack_require__(4862);
/**
  ...
  switch (scrollBehavior) {
    case 'stick-to-start':
      return {
        ...
        rawEndIndex: currentlyFocusedItemIndex + numberOfItemsVisibleOnScreen - 1 + halfNumberOfItemsNotVisible
      };
    case 'stick-to-end':
      return {
        rawStartIndex: currentlyFocusedItemIndex - numberOfItemsVisibleOnScreen + 1 - halfNumberOfItemsNotVisible,
...
const getNumberOfItemsVisibleOnScreen = ({
  data,
  listSizeInPx,
  itemSize
}) => {
  ...
  const itemSizeToComputeRanges = getMinSizeOfItems({
    data,
    itemSize
  });
...
exports.getAdditionalNumberOfItemsRendered = void 0;
/**
...
const getAdditionalNumberOfItemsRendered = (scrollBehavior, numberOfElementsVisibleOnScreen, additionalNumberOfItemsRendered) => {
  if (additionalNumberOfItemsRendered < 0) {
    console.error('[VirtualizedList] Negative number of additional items to render was given, no elements will be rendered');
  }
  switch (scrollBehavior) {
    case 'jump-on-scroll':
    ...
    default:
      return numberOfElementsVisibleOnScreen + MINIMUM_ADDITIONAL_ITEMS_TO_WORK + additionalNumberOfItemsRendered;
  }
};
exports.getAdditionalNumberOfItemsRendered = getAdditionalNumberOfItemsRendered;
...
const react_1 = __webpack_require__(9155);
const configureRemoteControl_1 = __webpack_require__(4247);
const DeviceContext_1 = __webpack_require__(169);
...
const react_native_1 = __webpack_require__(1389);
const ParentScrollContext_1 = __webpack_require__(134);
const scrollToNewlyfocusedElement_1 = __webpack_require__(7858);
const mergeRefs_1 = __webpack_require__(1622);
const useRemotePointerScrollviewScrollProps_1 = __webpack_require__(437);
const PointerScrollArrows_1 = __webpack_require__(9788);
const AnyScrollView_1 = __webpack_require__(1674);
...
exports.SpatialNavigationScrollView = (0, react_1.forwardRef)(({
  horizontal = false,
  style,
  offsetFromStart = 0,
  children,
  ...
  const {
    ...
    deviceType,
    deviceTypeRef
  } = (0, useRemotePointerScrollviewScrollProps_1.useRemotePointerScrollviewScrollProps)({
    pointerScrollSpeed,
    scrollY,
    scrollViewRef
  });
  ...
  return (0, jsx_runtime_1.jsxs)(ParentScrollContext_1.SpatialNavigatorParentScrollContext.Provider, {
    value: scrollToNode,
    children: [(0, jsx_runtime_1.jsx)(AnyScrollView_1.AnyScrollView, {
      useNativeScroll: useNativeScroll,
      scrollDuration: scrollDuration,
      ref: (0, mergeRefs_1.mergeRefs)([ref, scrollViewRef]),
      ...
      testID: testID,
      children: children
    }), deviceType === 'remotePointer' ? (0, jsx_runtime_1.jsx)(PointerScrollArrows_1.PointerScrollArrows, {
      descendingArrow: descendingArrow,
      ascendingArrow: ascendingArrow,
      descendingArrowContainerStyle: descendingArrowContainerStyle,
      ascendingArrowContainerStyle: ascendingArrowContainerStyle,
...
const react_1 = __importDefault(__webpack_require__(9155));
const react_native_1 = __webpack_require__(1389);
exports.PointerScrollArrows = react_1.default.memo(({
  ascendingArrow,
  descendingArrowProps,
  ascendingArrowContainerStyle,
  descendingArrow,
...
const configureRemoteControl_1 = __webpack_require__(4247);
var lrud_1 = __webpack_require__(795);
...
var Node_1 = __webpack_require__(1121);
...
var Root_1 = __webpack_require__(5025);
...
var ScrollView_1 = __webpack_require__(9322);
...
var View_1 = __webpack_require__(7882);
...
var DefaultFocusContext_1 = __webpack_require__(5900);
...
var SpatialNavigationVirtualizedList_1 = __webpack_require__(6806);
...
var SpatialNavigationVirtualizedGrid_1 = __webpack_require__(6286);
...
var useSpatialNavigatorFocusableAccessibilityProps_1 = __webpack_require__(5009);
...
var LockSpatialNavigationContext_1 = __webpack_require__(6466);
...
var FocusableView_1 = __webpack_require__(3602);
...
var DeviceContext_1 = __webpack_require__(169);
