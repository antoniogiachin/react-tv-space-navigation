 ...
 */
export declare const VirtualizedList: (<T>({ data, renderItem, itemSize, currentlyFocusedItemIndex, additionalItemsRendered, onEndReached, onEndReachedThresholdItemsNumber, style, orientation, nbMaxOfItems, keyExtractor, scrollDuration, listSizeInPx, scrollBehavior, testID, }: VirtualizedListProps<T>) => import("react/jsx-runtime").JSX.Element) & {
    displayName?: string;
};
